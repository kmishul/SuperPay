...
import com.project.wallet_service.util.EmailUtil;
...
public class EmailService {
    ...
    public static  final String FROM_EMAIL = "fromAddress@gmail.com"; //requires valid gmail id
    public static final String PASSWORD = "above_password"; // correct password for gmail id
